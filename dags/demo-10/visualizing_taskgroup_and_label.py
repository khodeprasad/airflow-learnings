...
with DAG(
    dag_id = 'd10_taskgroup_and_labels_pipeline_01',
    ...
    reading_and_preprocessing >> Label('Clean Data') >> determine_branch >> Label('Based on Variable is Branched') >> [filtering, grouping]