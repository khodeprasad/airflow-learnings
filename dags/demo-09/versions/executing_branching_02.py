...
DATASETS_PATH = '/Users/gangaprasadkhode/airflow/datasets/insurance.csv'

OUTPUT_PATH = '/Users/gangaprasadkhode/airflow/output/{0}.csv'
...
with DAG(
    dag_id = 'd09_executing_branching_02',
